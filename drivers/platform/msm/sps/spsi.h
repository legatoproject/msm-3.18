...
#else
#define	SPS_DBG3(x, msg, args...)	pr_debug(msg, ##args)
#define	SPS_DBG2(x, msg, args...)	pr_debug(msg, ##args)
#define	SPS_DBG1(x, msg, args...)	pr_debug(msg, ##args)
#define	SPS_DBG(x, msg, args...)	pr_debug(msg, ##args)
#define	SPS_INFO(x, msg, args...)	pr_info(msg, ##args)
#define	SPS_ERR(x, msg, args...)	pr_err(msg, ##args)
